        ...
        "2.1": Entry(
            ...
            highlights: [
                Highlight(icon: "apple.logo",
                          ...
                          detail: "Polish transcripts on-device with Apple Intelligence — no LM Studio, no server, nothing leaves your Mac."),
                ...
                Highlight(icon: "wand.and.sparkles",
                          title: "Transforms & Scratchpad",
                          detail: "Save reusable AI rewrites, and dictate into a floating scratchpad with ⌥⇧S."),
            ]),
        "2.2": Entry(
            version: "2.2",
